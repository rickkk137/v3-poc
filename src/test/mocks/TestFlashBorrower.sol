...
contract TestFlashBorrower {
    ...
    function takeLoan(address flashLender, address token, uint256 amount) external {
    ...
    function onFlashLoan(address from, address token, uint256 amount, uint256 fee, bytes calldata data) external returns (bytes32) {
