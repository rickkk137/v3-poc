...
contract Invariants is Functionalities {
    ...
    function invariantA1(address[] calldata userList, address yieldToken, uint256 tokensMinted, uint256 tokensBurned, uint256 sentToTransmuter) public {
    ...
    function invariantA3(address[] calldata userList, address yieldToken) public {
        ...
        AlchemistV3.YieldTokenParams memory params = alchemist.getYieldTokenParameters(yieldToken);
    ...
    function invariantA8(address[] calldata userList, address yieldToken, address underlyingToken) public {
    ...
    */
    function invariantA1Range(address[] calldata userList, address yieldToken, uint256 tokensMinted, uint256 tokensBurned, uint256 sentToTransmuter) public {
